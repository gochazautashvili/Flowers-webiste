                    ...
                    <nav className='mobileMenu__menu'>
                        <ul className="mobileMenu__menu_list">
                            <li className="mobileMenu__menu_item">
                                <NavLink to={'/'} className="mobileMenu__menu_link">HOME</NavLink>
                            </li>
                            <li className="mobileMenu__menu_item">
                                <NavLink to={'/flowers'} className="mobileMenu__menu_link">FLOWERS</NavLink>
                            </li>
                            <li className="mobileMenu__menu_item">
                                <NavLink to={'/about'} className="mobileMenu__menu_link">ABOUT US</NavLink>
                            </li>
