...
function Header() {
  ...
  document.addEventListener('click', (e) => {
    if (e.target.className === "cart__wrapper" || e.target.className === "mobileMenu__wrapper" || e.target.className === "wishlist__wrapper") {
      ...
      <div className="container">
        <div className="header__inner">
          <div className="header__logo">
            <NavLink to={'/'}>SOPHIE'S  <span>FLOWERS</span></NavLink>
          </div>
          <nav className='menu'>
            <ul className="menu__list">
              ...
              <li className="menu__item">
                <NavLink to={'/flowers'} className="menu__link">FLOWERS</NavLink>
              </li>
              <li className="menu__item">
          ...
          <div className="header__right">
            <div>
              <img onClick={() => navigate('/profile')} src={Profile__icon} alt="" />
            </div>
            <div className='header__right_box' onClick={handleWishlist}>
              <img src={Wishlist__icon} alt="" />
          ...
          <div className="header__burger_menu">
            <img className='burger' onClick={handleMenu} src={BurgerMenu__icon} alt="" />
          </div>
        </div>
      </div>
      {mobileMenu && <MobileMenu handleCart={handleCart} handleWishlist={handleWishlist} />}
